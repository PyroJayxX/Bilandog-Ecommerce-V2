...
export const Topnav: React.FC = () => {
    return (
        <nav className="w-full text-white p-4 md:p-8 lg:p-12 flex justify-start items-center flex-grow flex-shrink space-x-4 md:space-x-10 lg:space-x-20 text-sm md:text-xl lg:text-2xl font-serif" style={{position: 'absolute', top: 0, zIndex: 1000, background: 'linear-gradient(to bottom, black, transparent)', userSelect: 'none' }}>
