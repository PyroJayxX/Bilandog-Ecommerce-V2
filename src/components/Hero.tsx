...
export const Hero: React.FC = () => {
    return (
        <div className = 'flex flex-col flex-grow flex-shrink spacey-3 justify-center md:justify-end items-center md:items-start text-white font-serif text-5xl p-10 md:text-6xl md:px-20 xl:p-28 xl:text-7xl' style={{ backgroundImage: "url('/images/hero.png')", backgroundSize: "cover", backgroundPosition: "center", position: "relative" }}>
            ...
            <button className='bg-[#6C1814] text-white text-xl px-3 py-1 my-8 rounded-xl md:text-2xl md:px-6 md:py-2 md:my-16 md:rounded-2xl hover:bg-[#926F10] hover:text-white font-serif shadow-xl'
